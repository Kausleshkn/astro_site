...
function Condition() {
  return (
    <div className="text-center mx-28 pt-8">
      ...
      <br />
      <p>
        This website is operated by Neha Jain. Throughout the site, the terms
        “we”, “us” and “our” refer to Neha Jain. Neha Jain offers this website,
        ...
        <br />
        <br />
        In no case shall COZZMO, our directors, officers, employees, affiliates,
        ...
        <br />
        <br />
        You agree to indemnify, defend and hold harmless [COZZMO] and our
        ...
        enforceability of any other remaining provisions. SECTION 16 -
        TERMINATION
        <br />
        <br />
        ...
        laws of India and jurisdiction of Kanpur, Uttar Pradesh.
        <br />
        <br />
