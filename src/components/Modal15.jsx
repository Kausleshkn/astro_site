...
function Modal15() {
  ...
  const [formValues, setFormValues] = useState({
    productinfo: 'Holistic Treatement for Pregnancy',
    amount: '7777.00',
    firstname: '',
    name: '',
    email: '',
  ...
  useEffect(() => {
    if (isReadyToSubmit) {
      document.getElementById('paymentForm15').submit();
    }
  }, [isReadyToSubmit]);
  ...
  return (
    <>
      ...
      <form id="paymentForm15" action="https://test.payu.in/_payment" method="post" style={{ display: 'none' }}>
