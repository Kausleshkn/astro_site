...
function Modal17() {
  ...
  const [formValues, setFormValues] = useState({
    productinfo: 'Holistic Treatement Consultation for Health issues',
    amount: '5555.00',
    firstname: '',
    name: '',
    email: '',
  ...
  useEffect(() => {
    if (isReadyToSubmit) {
      document.getElementById('paymentForm17').submit();
    }
  }, [isReadyToSubmit]);
  ...
  return (
    <>
      ...
      <form id="paymentForm17" action="https://test.payu.in/_payment" method="post" style={{ display: 'none' }}>
