...
function Modal3() {
  ...
  useEffect(() => {
    if (isReadyToSubmit) {
      document.getElementById('paymentForm3').submit();
    }
  }, [isReadyToSubmit]);
  ...
  return (
    <>
      <div>
        <dialog id="my_modal_3" className="modal">
          <div className="modal-box">
            ...
            <h3 className="font-bold text-lg">MEDIUMSHI</h3>
            <p className="py-4">Mediumship is like tuning into a cosmic radio station to communicate with spirits 👻. A medium acts as a bridge between the physical world and the spirit realm, relaying messages, guidance, and comfort from departed loved ones or other spiritual entities 🌟. It's a sacred practice of connecting with the unseen energies and offering closure, healing, and validation to those seeking contact with the beyond 🕊️.
            </p>
            <div>
      ...
      <form id="paymentForm3" action="https://test.payu.in/_payment" method="post" style={{ display: 'none' }}>
