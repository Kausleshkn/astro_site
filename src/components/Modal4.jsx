...
function Modal4() {
  ...
  useEffect(() => {
    if (isReadyToSubmit) {
      document.getElementById('paymentForm4').submit();
    }
  }, [isReadyToSubmit]);
  ...
  return (
    <>
      <div>
        <dialog id="my_modal_4" className="modal">
          <div className="modal-box">
            ...
            <h3 className="font-bold text-lg">PAST LIFE REGRESSIONS ONLINE/OFFLINE</h3>
            <p className="py-4">Past life regression is a therapeutic technique that aims to explore memories and experiences from previous lifetimes 👥. Whether done online or offline, it involves guided visualization or hypnosis to access these supposed past lives 🌀. The goal is often to gain insight into current life patterns, fears, or relationships that may stem from past experiences, and to promote healing and understanding in the present 🌱.</p>
            <div>
      ...
      <form id="paymentForm4" action="https://test.payu.in/_payment" method="post" style={{ display: 'none' }}>
