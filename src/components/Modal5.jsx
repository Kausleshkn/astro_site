...
function Modal5() {
  ...
  useEffect(() => {
    if (isReadyToSubmit) {
      document.getElementById('paymentForm5').submit();
    }
  }, [isReadyToSubmit]);
  ...
  return (
    <>
      <div>
        <dialog id="my_modal_5" className="modal">
          <div className="modal-box">
            ...
            <h3 className="font-bold text-lg">LAMAFERA</h3>
            <p className="py-4">LAMAFERA is an acronym for a healing method that combines various holistic approaches, including Lifestyle, Attitude, Mindfulness, Awareness, Food, Exercise, Rest, and Alternative therapies. It emphasizes a comprehensive approach to healing, focusing on both physical and mental well-being. The method encourages individuals to make positive lifestyle changes, cultivate a positive attitude, practice mindfulness and awareness, consume nourishing foods, engage in regular exercise, prioritize rest, and explore alternative therapies to promote holistic health and healing.
              1 sitting </p>
            <div>
      ...
      <form id="paymentForm5" action="https://test.payu.in/_payment" method="post" style={{ display: 'none' }}>
