...
function Modal6() {
  ...
  const [formValues, setFormValues] = useState({
    productinfo: 'Humkara with Haleem',
    amount: '8888.00',
    firstname: '',
    name: '',
    email: '',
  ...
  useEffect(() => {
    if (isReadyToSubmit) {
      document.getElementById('paymentForm6').submit();
    }
  }, [isReadyToSubmit]);
  ...
  return (
    <>
      ...
      <form id="paymentForm6" action="https://test.payu.in/_payment" method="post" style={{ display: 'none' }}>
