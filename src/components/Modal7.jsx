...
function Modal7() {
  ...
  useEffect(() => {
    if (isReadyToSubmit) {
      document.getElementById('paymentForm7').submit();
    }
  }, [isReadyToSubmit]);
  ...
  return (
    <>
      <div>
        <dialog id="my_modal_7" className="modal">
          <div className="modal-box">
            ...
            <h3 className="font-bold text-lg">MARKESH HEALINGS</h3>
            <p className="py-4">Markesh healing is like removing energetic blockages and restoring balance within your life force ⚡. It's about identifying and addressing negative influences or obstacles that may be causing harm or stagnation 🚫. Through various energy healing techniques, Markesh healing aims to promote healing, clarity, and vitality 🌟. Think of it as a reset button for your energy system, helping you to thrive and find harmony 🌀.
              1 sitting </p>
            <div>
      ...
      <form id="paymentForm7" action="https://test.payu.in/_payment" method="post" style={{ display: 'none' }}>
